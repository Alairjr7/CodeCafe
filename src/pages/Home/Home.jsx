...
function Home() {
  ...
  function MoreInformation() {
    ...
    const buttonMoreInformation = document.getElementById(
      "more_information_button"
    );
    buttonMoreInformation.classList.toggle("active");

    const buttonLessInformation = document.getElementById(
      "less_information_button"
    );
    ...
    <>
      <header id="headerHome">
        <nav id="navbar">
          <div className="logo">
            {" "}
            <IoIosCafe /> <h1>CodeCafé</h1>
          </div>

          <ul id="nav_list">
            <li className="nav_item active">
              <a href="#home" onClick={buttonsHeader}>
                Inicio
              </a>
            </li>
            <li className="nav_item">
              <a href="#menu" onClick={buttonsHeader}>
                Cardápio
              </a>
            </li>
            <li className="nav_item">
              <a href="#testimony" onClick={buttonsHeader}>
                Avaliações
              </a>
            </li>
          </ul>

          <Link to="/login" className="order_here">
            Peça aqui
          </Link>
          <button className="button_Mobile" onClick={menuMobile}>
            <PiList />{" "}
          </button>
        </nav>
      ...
      <main className="container ">
        <section id="home">
          <div id="cta">
            <h1>
              Combustível para codar, sabor para{" "}
              <span style={{ color: "#A52A2A" }}>viver</span>
            </h1>

            <p className="description">
              A paixão pelo café se encontra com a arte da programação. Desfrute
              de bebidas exclusivas que são o combustível perfeito para codar e
              saborear a vida. Experimente o lugar onde o café e a tecnologia se
              encontram.
            </p>

            <div className="cta_buttons">
              <Link className="order_here" to="/login">
                {" "}
                Ver Cardápio{" "}
              </Link>
              <a href="">
            ...
            <div className="social_buttons">
              <a href="https://www.instagram.com/alaairjr_/" target="blank">
                {" "}
                <FaInstagram />{" "}
              </a>
              <a
                href="https://www.linkedin.com/in/alair-junior-494260273/"
                target="blank"
              >
                {" "}
                <FaLinkedinIn />{" "}
              </a>
              <a href="https://github.com/Alairjr7" target="blank">
                {" "}
                <LuGithub />{" "}
              </a>
            </div>
          ...
          <div className="testimony_container">
            ...
            <div className="testimony_description">
              ...
              <div className="testimony_card">
                ...
                <button
                  className="order_here "
                  id="more_information_button"
